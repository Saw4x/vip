...
\033[1;91m  >=>>=>         >=>      >=>           >=>>=>           >=>
\033[1;91m>=>    >=>     =>   >=     >=>         >=>  >=>         >=>       
\033[0;1m   >=>        >=> \033[1;33m  >=>     >=>\033[0;1m       >=>    >=>       >=>
\033[0;1m      >=>    >>=>>\033[1;33m=>>=>>     >=>     >=> \033[0;1m     >=>     >=>       1.2
\033[32;1m>=>    >=>  >>=       =>>     >=>   >=>        >=>   >=>
\033[32;1m  >=>>=>   >=>         >=>     >=>>=>           >=>>=>
\033[1;91m---------------------------------------------
\033[0;1mAUTHOR : \033[32;1mSAW
\033[0;1mTELEGRAM : \033[32;1mhttps://t.me/SAWx404
\033[0;1minstagram : \033[32;1m 127.0.2
\033[1;91m---------------------------------------------
"""
...
def chk():
  ...
  try:
    httpCaht = requests.get("https://github.com/Saw4x/s/blob/main/Saw.txt").text
    if id in httpCaht:
      print("\033[92m you id 30d ....")
      msg = str(os.geteuid())
      time.sleep(1)
      pass
    else:
    	
      print("\x1b[91m telegram @SAWx404 \033[0;1minstagram : \033[32;1m:127.0.2 .......")
      time.sleep(1)
      sys.exit()
  except:
    sys.exit()
...
def menu():
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[31;1m1 \033[0;1m] PUBLIC ID fb')
	print('\033[0;1m[ \033[31;1m2 \033[0;1m] PUBLIC ID fb ( VIP SAW  )')
	print('\033[0;1m[ \033[31;1m3 \033[0;1m] FOLLOWERS ID fb ')
...
def passwrd():
	os.system('clear')
	print(logo)
	print('\033[0;1m[ \033[31;1m+ \033[0;1m] SAW ID: \033[32m'+str(len(id))) 
